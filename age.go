...
type Age struct {
	...
	// Must be empty when IdentitySource is "keychain" (the recipient is derived
	...
	// Mutually exclusive with Identities and Recipient.
	IdentitySource string `json:"identity_source,omitempty"`

	mk     *age.MasterKey
	logger *zap.Logger

	// newStore overrides credential store creation for testing.
	// When nil, credstore.New() is used.
